...
This code is Forked from "YouTube Direct Lite for Android". The code is a reference implementation for an Android OS application that captures video, uploads it to YouTube, and submits the video to users Youtube Channel. Once uploaded a link is given which directs to the uploaded video.
