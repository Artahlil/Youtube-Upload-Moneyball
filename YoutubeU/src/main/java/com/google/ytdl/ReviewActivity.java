...
public class ReviewActivity extends Activity {
    ...
    public void uploadVideo(View view) {
        ...
        if (mFileUri != null) {
            ...
            Toast.makeText(this, "Refresh in a 2-5 minutes to see uploaded DARE",
                    Toast.LENGTH_LONG).show();
            Toast.makeText(this,"Once Video Appears click on it to receive Share Link",
                    Toast.LENGTH_LONG).show();
            Toast.makeText(this, "If Video doesn't appear within 5 minutes re-upload",
                    Toast.LENGTH_LONG).show();
